<h1 align="center">🎬 XiaoYu.AI —— AI 全自动短视频引擎</h1>
...
<p align="center">
  ...
  <a href="https://github.com/AIDC-AI/XiaoYu.AI/releases" target="_blank"><img src="https://img.shields.io/badge/📦 Windows包-50C878" alt="Windows整合包"></a>
  <a href="https://aidc-ai.github.io/XiaoYu.AI/zh" target="_blank"><img src="https://img.shields.io/badge/📘 使用文档-4A90E2" alt="使用文档"></a>
...
XiaoYu.AI 采用模块化设计，整个视频生成流程清晰简洁：
...
以下是使用 XiaoYu.AI 生成的实际案例，展示了不同主题和风格的视频效果：
...
👉 **[下载 Windows 一键整合包](https://github.com/AIDC-AI/XiaoYu.AI/releases/latest)**
...
- 🔗 [查看所有模板效果图](https://aidc-ai.github.io/XiaoYu.AI/zh/user-guide/templates/#_3)
