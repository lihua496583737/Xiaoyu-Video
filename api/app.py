...
async def lifespan(app: FastAPI):
    ...
    """
    # Startup
    logger.info("🚀 Starting XiaoYu.AI API...")
    await task_manager.start()
    logger.info("✅ XiaoYu.AI API started successfully\n")
    
    yield
    
    # Shutdown
    logger.info("🛑 Shutting down XiaoYu.AI API...")
    await task_manager.stop()
    await shutdown_pixelle_video()
    logger.info("✅ XiaoYu.AI API shutdown complete")
...
app = FastAPI(
    title="XiaoYu.AI API",
    description="""
    ## XiaoYu.AI - AI Video Generation Platform API
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Start XiaoYu.AI API Server")
