#!/usr/bin/env python3
"""
Windows Package Builder for XiaoYu.AI
...
class WindowsPackageBuilder:
    """Build Windows portable package for XiaoYu.AI"""
    ...
    def build(self):
        ...
        try:
            ...
            # Copy project files
            project_target = self.build_dir / "XiaoYu.AI"
...
def main():
    parser = argparse.ArgumentParser(description="Build Windows portable package for XiaoYu.AI")
    parser.add_argument(
        '--config',
