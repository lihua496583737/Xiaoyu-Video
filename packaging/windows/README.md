...
Automated build system for creating Windows portable packages of XiaoYu.AI.
...
```
dist/windows/
├── XiaoYu.AI-v*-win64/             # Build directory (version number varies)
│   ├── python/                         # Python embedded
│   ├── tools/                          # FFmpeg, etc.
│   ├── XiaoYu.AI/                  # Project files
...
├── XiaoYu.AI-v*-win64.zip          # ZIP package (version number varies)
└── XiaoYu.AI-v*-win64.zip.sha256   # Checksum (version number varies)
```
...
```bash
# Windows PowerShell
Get-FileHash XiaoYu.AI-v*-win64.zip -Algorithm SHA256
```
...
Same as XiaoYu.AI project license.
